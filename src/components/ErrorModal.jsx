...
const ErrorModal = ({ onClose }) => (
  <div className="fixed inset-0 z-50 flex items-center justify-center bg-black bg-opacity-60">
    <div className="bg-slate-900/95 mx-auto px-4 rounded-2xl p-8 flex flex-col items-center shadow-inner shadow-verde-vr">
      <Lottie animationData={successAnimation} style={{ width: 180, height: 120 }} loop={true} />
      <h2 className="text-white-100 text-lg font-bold mt-4 mb-2">Mensagem enviada com sucesso!</h2>
